...
namespace Concrete\Package\ThinkStory\Entity\Attribute\Key\Settings;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="atTimbreSettings")
 */
class TimbreSettings extends Settings implements FileProviderInterface
{
    /**
